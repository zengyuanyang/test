         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jifangxinxi_list2.jsp" target="right">机房查询与申请</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jiaoshishenqing_list2.jsp" target="right">我的申请管理</a></td>
                  </tr>
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   <tr>
                    ...
                    <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kechengxinxi_add.jsp" target="right">课程信息添加</a></td>
                  </tr> 
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="kechengxinxi_list.jsp" target="right">课程信息查询</a></td>
                  </tr>
                    <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="paike_list2.jsp" target="right">排课信息查询</a></td>
                  </tr>               
                   <tr>
                     <td height="5"></td>
                   </tr>
