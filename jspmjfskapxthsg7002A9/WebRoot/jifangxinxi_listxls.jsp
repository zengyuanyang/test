...
response.addHeader("Content-Disposition", "attachment;filename=jifangxinxi.xls");
%>
<html>
  <head>
    <title>机房信息</title>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td  style="display:none"  bgcolor='#CCFFFF'>状态</td>
...
//youzuiping2
  ...
  <tr>
    ...
    <td style="display:none" ><%=map.get("zhuangtai") %></td>
