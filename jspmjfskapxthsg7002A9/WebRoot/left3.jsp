        ...
        <td><table width="188" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                  ...
                  <tr>
                    <td class="menubg1" onMouseover="this.className='menubg2'" onMouseout="this.className='menubg1'"><a href="xueshengxinxi_updt2.jsp" target="right">个人资料管理</a> </td>
                  </tr>
         ...
         <td><table width="188" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr>
               <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="menubg">
                   ...
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jifangxinxi_list3.jsp" target="right">机房安排查看</a></td>
                  </tr>
                   <tr>
                     <td class="menubg1" onmouseover="this.className='menubg2'" onmouseout="this.className='menubg1'"><a href="jifangxinxi_list4.jsp" target="right">临时机房调整</a></td>
                  </tr>
