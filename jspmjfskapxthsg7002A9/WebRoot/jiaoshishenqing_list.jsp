...
<html>
  ...
  <form name="form1" id="form1" method="post" action="">
   ...
   <input type="submit" name="Submit" value="查找" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit2" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' onClick="javascript:location.href='jiaoshishenqing_listxls.jsp';" />
</form>
...
if (request.getParameter("shiyongriqi2")==""  ||request.getParameter("shiyongriqi2")==null ) {}else {sql=sql+" and shiyongriqi <= '"+request.getParameter("shiyongriqi2")+"'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="jiaoshishenqing_updtlb.jsp?id=<%=map.get("id")%>">回复</a>  <a href="jiaoshishenqing_list.jsp?scid=<%=map.get("id") %>" onClick="return confirm('真的要删除？')">删除</a> <a href="jiaoshishenqing_detail.jsp?id=<%=map.get("id")%>">详细</a> </td>
  </tr>
  	<%
  }
   %>
