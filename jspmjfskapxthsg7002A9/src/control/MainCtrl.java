		...
		if(ac.equals("adminlogin"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if (utype.equals("教师"))
				{
					...
					if (utype.equals("值班人员"))
					{
					sql1 = "select * from zhibanrenyuanxinxi where xuehao='"+username+"' and mima='"+password+"'"; 
			...
			if (utype.equals("教师"))
				{
					...
					request.getSession(). setAttribute("jsxm", userlist1.get(0).get("jiaoshixingming")); 
